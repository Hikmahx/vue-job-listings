...
// We use `any` here because the Xenova pipeline type is complex internally
// and doesn't affect how we use it — we just call it as a function
 ...
 * @param inputType - Unused (kept for API compatibility with Voyage AI)
 ...
 * @param inputType - Unused (kept for API compatibility)
